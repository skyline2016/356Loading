...
$(document).ready(function () {
	...
	$('#button-ipad_pro_9').click(app.callbacks.ipad_pro_9);
	$('#button-ipad_pro_12').click(app.callbacks.ipad_pro_12);
	$('#button-iphone_7_plus').click(app.callbacks.iphone_7_plus);
	$('#button-iphone_7').click(app.callbacks.iphone_7);
	$('#button-ipad_mini').click(app.callbacks.ipad_mini);
	$('#button-macbook').click(app.callbacks.macbook);
